...
const plans = [
  {
    ...
    items: ["Basic sales recording", "Simple product list", "Daily totals", "Basic reports"],
    highlight: false,
  },
  {
    name: "Trader",
    ...
    items: ["Unlimited sales history", "Stock tracking", "Receipts", "Weekly & monthly reports", "Product performance"],
    highlight: true,
    badge: "Most Popular",
  },
  {
    ...
    items: ["Staff access", "Cash-up", "Inventory tools", "Advanced reports", "Business settings"],
    highlight: false,
  },
  {
    name: "Growth",
    ...
    items: ["Multi-branch support", "Advanced permissions", "Exports", "Priority support", "Growth tools"],
    highlight: false,
  },
];
